    ...
    <div className="input-content">
      <form action="" onSubmit={handleSubmit}>
        <div className="">
          ...
          <input type="text" placeholder="Enter your name" onChange={(e) => setAuthor(e.target.value)}/><br />
        </div>
        <div className="input">
        ...
        <div className="input">
          ...
          <input type="text" placeholder="Enter the Blog heading" onChange={(e) => setHeading(e.target.value)}/>
        </div>
        <div className="input">
